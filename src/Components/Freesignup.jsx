...
const Freesignup = () => {
  return (
      <div className='bg-gradient-to-l   text-white md:h-24 h-20 lg:h-24 from-[#AF2896] via-[#7270d1]  to-[#509BF5] w-screen  justify-between  flex'>
          
            <div className='p-3 '>
                <h1 className='text-sm lg:text-md md:text-md' >Preview of Spotify</h1>
